...
#   OFF: -> ON
#   ERR: -> ignore
#   dict('state', 'allowed state')

# loop over each line
#   split on ' ' (space) into array (into named elements for later parsing)
#   is 'Device State:' in array?
#       yes: get last element in array
#           is last element af key in states ?         
#                yes: 
#                   store the line
#                   get value to match for complete on/off cycle
#                      does this value match the last element ?
#                           yes: ON/OFF powercycle found - get 
#                   
#    
# print(states['ERR'])
# print(log[200].GetTimeStamp(), log[200].GetPayLoad())
...
ParseLog('Device State:', './Challenges/logfile.log')
